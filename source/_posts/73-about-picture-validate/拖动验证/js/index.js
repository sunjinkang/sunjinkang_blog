...
// 接下来我们来获取一下 DOM 节点
let imgBox = $('.imgBox'); // 图片容器
let imgBlock = $('.imgBlock'); // 可以拖动的图片
let imgGap = $('.imgGap'); // 图片缺口
let title = $('.imgContainer h3'); // 获取标题
let slider = $('.slider'); // 滑块条
let btn = $('#btn'); // 拖动的滑块
let span = $('.slider span'); // 滑块条的文字

// 初始化函数
function init() {
  // 1. 随机生成背景图片
  let imgArr = ['t1.png', 't2.png', 't3.png', 't4.png', 't5.png']; // 存储所有图片的数组
